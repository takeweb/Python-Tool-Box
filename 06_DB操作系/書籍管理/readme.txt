...
# キー指定で１件更新
python manageBook.py -m upd_key -i 3 -n "JavaScript Primer2" -sa "株式会社 KADOKAWA" -a "azu, Suguru Inatomi"
...
# キーが「１」のデータの詳細表示
http://localhost:5001/detail/1

# キーが「１」のデータの物理削除
http://localhost:5001/delete/1
