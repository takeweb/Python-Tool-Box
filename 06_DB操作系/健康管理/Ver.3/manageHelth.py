...
import argparse, datetime, os, pathlib, re, sqlite3, sys
...
if __name__ == '__main__':
    try:
        ...
        parser.add_argument('-t', '--height', default=176.7)
        ...
        if mode == 'save':
            ...
            print("適正体重:" + str(suitable_weight) + "kg")
            print("目標体重:" + "78kg" + " / あと: " + str(round((78 - weight) * -1, 2)) + "kg！")
